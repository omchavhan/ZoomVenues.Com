...
class AVenuesEnquiry:
    ...
    sitting_xpath = "(//*[@class='form-check-input arrangements custom-control-input'])[1]"
    ...
    def setFinaloffer(self,finalOffer):
        self.driver.find_element(By.XPATH, self.finalOffer_xpath).send_keys(Keys.CONTROL, 'a')
        self.driver.find_element(By.XPATH, self.finalOffer_xpath).send_keys(Keys.DELETE)
        self.driver.find_element(By.XPATH, self.finalOffer_xpath).send_keys(finalOffer)

    def setTermCondtion(self,termCondition):
        self.driver.find_element(By.XPATH, self.termCond_xpath).clear()
        self.driver.find_element(By.XPATH, self.termCond_xpath).send_keys(termCondition)

    def setCmdBH(self,cmdBH):
        self.driver.find_element(By.XPATH, self.cmdForBH_xpath).clear()
